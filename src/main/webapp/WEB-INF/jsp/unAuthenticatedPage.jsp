...
<body class="no-skin" style="background-color:rgb(239, 240, 240) !important;">
	...
	<div class="logo">
				...
				<div>
				<img src="./assets/img/elecnorIcon.png" alt="" style="border: 1px solid #ccc;padding: 8px 0px;width: 120px;\height: 100px;">
					<div>
						<h1 style="color:#B3B3B3;">Unauthenticated User !</h1>
						<p class="text-muted">
						</p>
						<h3>Your are not authenticated to access this application or Your plan has been expired.</h3>
