				...
				<div class="col-sm-12">
					<div class="text-center error-box">
						...
						<p class="lead semi-bold">
							...
							<small>
								Our System has already sent a email to the Development  <br> team about this issue. We will try to fix the issue ASAP.
							</small>
						</p>
						<!-- <ul class="error-search text-left font-md">
				            <li><a href="#dashboard"><small>Go to My Dashboard <i class="fa fa-arrow-right"></i></small></a></li>
